 ...
 *
 * ```js
 * var scanwordui = angular.module('scanwordui', []);
 * scanwordui.run(function($templateCache) {
 ...
 *
 * ```
 *  angular.module('scanwordui', []).config(function($sceDelegateProvider) {
 ...
 *      'http://scanwordui.example.com/clickThru**'
 *    ]);
 *  });
 * ```
 */

...
describe('ContactsController', function() {
    ...
    var contactsStub = {"meta": {"limit": 1000, "next": null, "offset": 0, "previous": null, "total_count": 13},
        "objects": [
    ...
    describe('if server 200 and contacts exist', function() {
        ...
        beforeEach(inject(function($injector){
            ...
            $httpBackend.when('GET', 'api/v1/contact').respond(200, contactsStub);
        ...
        it('should contain 13 items', function () {
            ...
            expect($scope.contacts.length).toBe(13);
    ...
    describe('if server 200 and no contacts', function() {
        ...
        beforeEach(inject(function($injector){
            ...
            $httpBackend.when('GET', 'api/v1/contact').respond(200, {"meta":empty_meta, "objects": []});
            $controller('ContactsController', { $scope: $scope });
    ...
    describe('if server 500', function() {
        ...
        beforeEach(inject(function($injector){
            ...
            $httpBackend.when('GET', 'api/v1/contact').respond(500, null);
            $controller('ContactsController', { $scope: $scope });
